...
public class SavePhotoFragment extends BaseFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mDescription.setHint(ResourcesUtil.getString(getActivity(), "hint_comment"));
