package com.sdex.webteb.view.switchbutton;
...
public class SwitchButton extends CompoundButton {
	...
	private Drawable fetchThumbDrawable(TypedArray ta) {
		...
		Drawable tempDrawable = ta.getDrawable(R.styleable.SwitchButton_sb_thumbDrawable);
		if (tempDrawable != null) {
			return tempDrawable;
		}

		int normalColor = ta.getColor(R.styleable.SwitchButton_sb_thumbColor, Configuration.Default.DEFAULT_THUMB_COLOR);
		int pressedColor = ta.getColor(R.styleable.SwitchButton_sb_thumbPressedColor, Configuration.Default.DEFAULT_THUMB_PRESSED_COLOR);
